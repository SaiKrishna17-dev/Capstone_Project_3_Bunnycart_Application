...
public class SignInPageObjects extends Browser {
    ...
    public static List<WebElement> signOut() {
		return driver.findElements(signOut);
	}
    ...
    public static List<WebElement> verifyMessage() {
		return driver.findElements(textMessage);
	}
