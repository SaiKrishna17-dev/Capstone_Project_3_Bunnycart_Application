...
import com.Bunnycart.Locators.AddToCartPageObjects;
...
public class AddToCartPage extends Browser {
	...
	public static void clickOnSignInLink() {
    	...
    	try {
    		...
    		WebElement signInLink= wait.until(ExpectedConditions.elementToBeClickable(AddToCartPageObjects.signInLink));
    		signInLink.click();
	...
	public static void enterEmail(String str) {
		...
		try {
			Thread.sleep(2000);
			AddToCartPageObjects.email().sendKeys(str);
	...
	public static void enterPassword(String str) {
		...
		try
		{
			AddToCartPageObjects.password().sendKeys(str);
	...
	public static void clickSignIn() {
		...
		try
		{
			AddToCartPageObjects.signInButton().click();
	...
	public static void enterSearchData(String str) {
		...
		{
			Thread.sleep(4000);
			AddToCartPageObjects.search().sendKeys(str);
	...
	public static void selectItemInSearch() {
		...
		{
			Thread.sleep(4000);
			List<WebElement> searchList= AddToCartPageObjects.searchList();
